...
app = Flask(__name__)
CORS(app)  # מאפשר לפרונט לפתוח index.html ולקרוא ל-API בלי בעיות CORS
...
def similar():
    ...
    # חישוב "מרחק" פשוט בין רכבים (נורמליזציה גסה)
    df = cars_df.copy()

    # תעדוף התאמות קטגוריות
